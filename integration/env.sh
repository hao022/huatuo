...
JAVA_PROFILER_TOOL_PATH=${JAVA_PROFILER_TOOL_PATH:-${ROOT_DIR}/_output/tools/async-profiler}
export JAVA_PROFILER_TOOL_PATH
PYTHON_PROFILER_TOOL_PATH=${PYTHON_PROFILER_TOOL_PATH:-${ROOT_DIR}/_output/tools/py-spy}
